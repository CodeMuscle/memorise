  ...
  return (
    <div className="text-sm">
      ...
      <div className="mt-2 px-1 pb-1">
        <p className="hidden last:block text0xs text-center text-muted-foreground pb-2">
          No documents found.
        </p>
        {filteredDocument?.map((document) => (
          <div role="button" onClick={() => onClick(document._id)} key={document._id} className="text-sm rounded-sm w-full hover:bg-primary/5 flex items-center text-primary justify-between">
            ...
            <div className="flex items-center">
              ...
              <ConfirmModal onConfirm={() => onRemove(document._id)}>
                <div role="button" className="rounded-sm hover:bg-neutral-200 dark:hover:bg-neutral-600 p-2">
